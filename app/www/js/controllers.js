angular.module('starter.controllers', ['cordovaDeviceModule', 'cordovaDeviceMotionModule', 'cordovaNetworkInformationModule', 'cordovaVibrationModule', 'cordovaGeolocationModule'])
    ...
    .controller('AboutCtrl', function ($scope) {
        ...
        $scope.resources = [
            {description: 'My LinkedIn Profile', url: 'https://www.linkedin.com/in/rcranley'},
            {description: 'My GitHub Profile', url: 'http://github.com/rcranley'},
            {description: 'My Website', url: 'http://ronancranley.com'},
            {description: 'Who I work for', url: 'http://point97.io'}
